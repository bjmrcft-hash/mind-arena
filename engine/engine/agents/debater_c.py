"""
Agent C — Con Debater (反方批判者).

Each response: 【回应对方】30-40% + 【发表己见】60-70%.
Uses reductio ad absurdum and structural critique.
"""
